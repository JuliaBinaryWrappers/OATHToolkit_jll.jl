...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OATHToolkit_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2f89d1c9-c8cc-56a0-9b6f-1a564073fb5a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OATHToolkit", artifacts_toml) for e in artifacts["OATHToolkit"]]
...
if best_platform === nothing
    @debug("Unable to load OATHToolkit; unsupported platform $(triplet(platform_key_abi()))")
else
